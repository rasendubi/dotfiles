...
local battery_widget = battery.get_widget("BAT0")
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey, "Shift"   }, "Return", function () awful.spawn(geditor) end,
...
clientkeys = awful.util.table.join(
    ...
    awful.key({ modkey, "Shift" }, "f",
        ...
        {description = "toggle full-fullscreen", group = "client"}),
...
skype_properties = screen:count() ~= 1 and { screen = 2, tag = "1" } or { screen = 1, tag = "9" }
...
awful.rules.rules = {
    ...
    { rule = { instance = "plugin-container" },
      properties = { floating = true } },
    { rule = { class = "Skype" },
      properties = awful.util.table.join({ size_hints_honor = false }, skype_properties) },
}
-- }}}
