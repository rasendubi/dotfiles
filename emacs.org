...
Dim drawer faces (they are not that important).
#+name: org-config
#+begin_src emacs-lisp
(set-face-attribute 'org-special-keyword nil :inherit 'shadow :weight 'bold :height 0.9)
#+end_src
...
(setq-default org-todo-keyword-faces
              '(("TODO"     . (:foreground "dodger blue" :weight bold))
                ...
                ; ("BUILD"    . (:foreground "#a6e22e" :weight bold))
