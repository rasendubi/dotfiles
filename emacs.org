    ...
    (save-window-excursion
      (with-current-buffer (or base (current-buffer))
        (org-with-wide-buffer
         (goto-char pos)
         (rasen/org-capture-exact file path arg))))
...
(rasen/make-refile-hydra rasen/org-refile-hydra-resources "Resources"
  ...
  ("p" "Programming languages"  "~/org/plan.org"     "Resources" "Programming languages")
...
(use-package org-roam
  ...
  (setq org-roam-directory (concat rasen/org-directory "/roam")
        org-roam-db-filename (expand-file-name "cache/org-roam.db" user-emacs-directory))
...
(defun rasen/set-my-fonts ()
  (cond ((rasen/font-exists-p "Fira Code Retina")
  ...
  (cond ((rasen/font-exists-p "Vollkorn")
...
*** Fira Code Ligatures
Copied from https://github.com/tonsky/FiraCode/wiki/Emacs-instructions#using-prettify-symbols.
(TODO: replace with [[https://melpa.org/#/fira-code-mode][fira-code-mode]] once available in nixpkgs.)
...
(setq org-variable-pitch-fixed-font "Fira Code Retina")
