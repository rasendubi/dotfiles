...
(use-package org-roam
  ...
  (defun rasen/org-roam--file-name (title)
    ...
    (let* ((s (s-downcase title))
           ...
           (s (s-join "-" s)))
      s))
  (setq org-roam-file-name-function #'rasen/org-roam--file-name)
...
(use-package monokai-theme
  ...
  (let* (;; Darker and lighter accented colors
    ...
    (custom-theme-set-faces
     ...
     `(org-link ((t :foreground ,monokai-cyan
                    :underline t)))
     `(org-roam-link ((t :foreground ,monokai-green-l
                         :inherit org-link)))
     `(org-roam-backlink ((t ;; no styling
                           )))

     `(org-super-agenda-header ((t :background ,monokai-background
