                ...
                profiles = [
                  {
                    ...
                    complex_modifications.rules = [
                      {
                        description = "S-<return> to Terminal";
                        manipulators = [
                          {
                            type = "basic";
                            conditions = [
                            ...
                            to = [{ shell_command = "cd ~; /Users/rasen/.nix-profile/bin/emacsclient -c -e '(progn (vterm) (set-window-dedicated-p nil t))'"; }];
                          }
                        ];
                      }
                      {
                        description = "remap s-C-j/l to S-C-left/right for space switching";
                        manipulators = [
                          {
                            type = "basic";
                            from = {
                              key_code = "j";
                              modifiers.mandatory = ["left_gui" "left_control"];
                            };
                            to = {
                              key_code = "left_arrow";
                      ...
                      {
                        description = "ctrl to switch keyboard layout";
                        manipulators = [
                          {
                            type = "basic";
                            conditions = [{ type = "input_source_unless"; input_sources = [{ language = "en"; }]; }];
                            from.key_code = "left_control";
                            to = [{ select_input_source.input_source_id = "org.sil.ukelele.keyboardlayout.workman.workman"; }];
                          }
                          {
                            type = "basic";
                      ...
                      {
                        description = "fn key to switch keyboard layout";
                        manipulators = [
                          {
                            type = "basic";
                            conditions = [{ type = "input_source_unless"; input_sources = [{ language = "en"; }]; }];
                            ...
                            to_if_alone = [{ select_input_source.input_source_id = "org.sil.ukelele.keyboardlayout.workman.workman"; }];
                      ...
                      {
                        description = "Post escape if caps_lock is tapped";
                        manipulators = [
                          {
                            type = "basic";
                            from = {
